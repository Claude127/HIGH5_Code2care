...
import {Filter, Globe, Mail, MessageSquare, MoreHorizontal, Phone, Plus, Search, User} from "lucide-react"
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                                            <div className="text-left sm:text-right space-y-2">
                                                <div className="flex items-center gap-2">
                                                    <Globe
                                                        className="icon-responsive-sm text-muted-foreground flex-shrink-0"/>
                                                    <Badge
                                                        variant="secondary"
                                            ...
                                            <div className="button-group-responsive">
                                                ...
                                                <Button variant="outline"
                                                        className="btn-responsive-icon-sm bg-transparent">
