...
import {Archive, Calendar, Flag, Globe, MessageSquare, Reply, Search, Star, ThumbsDown, ThumbsUp} from "lucide-react"
            ...
            <div className="mobile-container">
                <div className="mobile-content space-y-4 sm:space-y-6 lg:space-y-8 animate-fade-in">
                    ...
                    <div className="flex flex-col space-y-3 sm:space-y-4">
                        <div
                            className="flex flex-col space-y-2 sm:flex-row sm:justify-between sm:items-start sm:space-y-0">
                            ...
                            <div className="button-group-responsive w-full sm:w-auto mt-2 sm:mt-0">
                                ...
                                <Button
                                    className="btn-responsive bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 gap-1 sm:gap-2 flex-1 sm:flex-none">
                        ...
                        {filteredFeedbacks.map((feedback, index) => (
                            ...
                            >
                                        ...
                                        <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                                            ...
                                            <div className="space-y-1 sm:space-y-2 min-w-0 flex-1">
                                                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                                                    ...
                                                    <Badge
                                                        className={`${getStatusColor(feedback.status)} text-xs px-1 sm:px-2`}>
                                                        {feedback.status}
                                                    </Badge>
                                                </div>
                                                <div
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <span
                                                            className="truncate">{new Date(feedback.createdAt).toLocaleDateString()}</span>
                                                    </div>
                                                    <div className="flex items-center gap-1">
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div
                                        className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3 sm:p-4 bg-background/50 rounded-lg">
                                        <div
                                            className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 min-w-0 flex-1">
                                            <Badge
                                                variant="secondary"
                                            ...
                                            <div className="flex items-center gap-1 sm:gap-2">
                                                <div
                                                    className="flex items-center gap-0.5 sm:gap-1">{renderStars(feedback.rating)}</div>
                                                <span
                                                    className="text-xs sm:text-sm font-medium">{feedback.rating}/5</span>
                                            </div>
                                        </div>
                                    ...
                                    {feedback.status === "pending" && (
                                        <div
                                            className="space-y-3 p-3 sm:p-4 bg-background/20 rounded-lg border-l-4 border-primary-500">
                                            ...
                                            <div className="button-group-responsive">
                                                <Button
                                                    className="btn-responsive-sm bg-gradient-to-r from-primary-500 to-secondary-500 flex-1 sm:flex-none">
                                                    Send Response
                                                </Button>
                                                <Button variant="outline"
                                                        className="btn-responsive-sm bg-transparent flex-1 sm:flex-none">
                                                    Mark as Reviewed
                                                </Button>
                                            </div>
                                        </div>
